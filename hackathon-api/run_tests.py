...
# Insert project root to path for importing chunker
...
# 1. Chunk and print chunks locally (matches what will be ingested)
...
try:
    ...
    print("Ingest success to server.\n")
except Exception as e:
    print("Ingest failed:", e)
    sys.exit(1)

# 3. Test Case 3 query
q = "Since Notion doesn't sell my data to advertisers, I don't need to worry about them using my activity for targeted ads, right?"
print(f"======================================")
print(f"TEST CASE 3: {q}")
print(f"======================================")
try:
