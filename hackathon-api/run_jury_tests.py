...
queries = [
    "Does Notion sell my commercial information to advertisers?",
    "How many sick days do employees get?",
    "Since Notion doesn't sell my data to advertisers, I don't need to worry about them using my activity for targeted ads, right?",
]
...
for i, q in enumerate(queries, 1):
    ...
    try:
        ...
        # Only print the jurors part as requested to verify reasoning strings
        data = res.json()
        print(f"ANSWER:\n{data['answer']}")
        print(f"\nJURORS:")
