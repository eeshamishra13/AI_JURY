...
queries = [
    "If I request deletion of my data, does that mean all my information will be immediately erased from Notion's systems?",
    "Is my geolocation data sold to advertisers?",
    "Since Notion keeps my data as long as necessary for legal compliance, does that mean they can keep it forever if they want?"
]
